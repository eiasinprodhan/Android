...
public class SignInDigit extends AppCompatActivity {
    ...
    private final List<OptionItem> anaOptions = Arrays.asList(new OptionItem("⁄ - ১ আনা", 1), new OptionItem("৵ - ২ আনা", 2), new OptionItem("৶ - ৩ আনা", 3), new OptionItem("৷ - ৪ আনা", 4), new OptionItem("৷⁄ - ৫ আনা", 5), new OptionItem("৷৵ - ৬ আনা", 6), new OptionItem("৷৶ - ৭ আনা", 7), new OptionItem("৷৷ - ৮ আনা", 8), new OptionItem("৷৷⁄ - ৯ আনা", 9), new OptionItem("৷৷৵ - ১০ আনা", 10), new OptionItem("৷৷৶ - ১১ আনা", 11), new OptionItem("৸ - ১২ আনা", 12), new OptionItem("৸⁄ - ১৩ আনা", 13), new OptionItem("৸৵ - ১৪ আনা", 14), new OptionItem("৸৶ - ১৫ আনা", 15));
    private final List<OptionItem> gondaOptions = Arrays.asList(new OptionItem("১ গন্ডা", 1), new OptionItem("২ গন্ডা", 2), new OptionItem("৩ গন্ডা", 3), new OptionItem("৪ গন্ডা", 4), new OptionItem("৫ গন্ডা", 5), new OptionItem("৬ গন্ডা", 6), new OptionItem("৭ গন্ডা", 7), new OptionItem("৮ গন্ডা", 8), new OptionItem("৯ গন্ডা", 9), new OptionItem("১০ গন্ডা", 10), new OptionItem("১১ গন্ডা", 11), new OptionItem("১২ গন্ডা", 12), new OptionItem("১৩ গন্ডা", 13), new OptionItem("১৪ গন্ডা", 14), new OptionItem("১৫ গন্ডা", 15), new OptionItem("১৬ গন্ডা", 16), new OptionItem("১৭ গন্ডা", 17), new OptionItem("১৮ গন্ডা", 18), new OptionItem("১৯ গন্ডা", 19));
    private final List<OptionItem> koraOptions = Arrays.asList(new OptionItem("৷ - ১ কড়া", 1), new OptionItem("৷৷ - ২ কড়া", 2), new OptionItem("৸ - ৩ কড়া", 3));
    private final List<OptionItem> krantiOptions = Arrays.asList(new OptionItem("৴ - ১ ক্রান্তি", 1), new OptionItem("৴৴ - ২ ক্রান্তি", 2));
    private final List<OptionItem> tilOptions = Arrays.asList(new OptionItem("১ তিল", 1), new OptionItem("২ তিল", 2), new OptionItem("৩ তিল", 3), new OptionItem("৪ তিল", 4), new OptionItem("৫ তিল", 5), new OptionItem("৬ তিল", 6), new OptionItem("৭ তিল", 7), new OptionItem("৮ তিল", 8), new OptionItem("৯ তিল", 9), new OptionItem("১০ তিল", 10), new OptionItem("১১ তিল", 11), new OptionItem("১২ তিল", 12), new OptionItem("১৩ তিল", 13), new OptionItem("১৪ তিল", 14), new OptionItem("১৫ তিল", 15), new OptionItem("১৬ তিল", 16), new OptionItem("১৭ তিল", 17), new OptionItem("১৮ তিল", 18), new OptionItem("১৯ তিল", 19));
    ...
    private void setupDropdown(final AutoCompleteTextView dropdown, String title, List<OptionItem> options) {
        ...
        dropdown.setOnClickListener(v -> {
            ...
            new MaterialAlertDialogBuilder(SignInDigit.this).setTitle(title).setSingleChoiceItems(optionNames, selectedIndex, (dialog, which) -> {
    ...
    private void updateResult() {
        ...
        double shataksh = (double) multipliedNumerator / 76800; // শতাংশ
        double ekor = shataksh / 100.0; // একর
